...
lint:
	flake8 changeformrepro tests

test:
	python manage.py test changeformrepro --traceback
...
coverage:
	coverage run --source changeformrepro setup.py test
	coverage report -m
	coverage html
	open htmlcov/index.html

docs:
	rm -f docs/changeformrepro.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ changeformrepro
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
